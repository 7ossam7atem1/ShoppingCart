...
const tweetList = [
  {
    ...
    desc: (
      <p>
        Hossam Hatem <a href="#">@ShopCart Greetings! #HTML_Template</a> Grab
  ...
  },
  {
    ...
    desc: (
      <p>
        Luka Modric <a href="#">@ShopCart Hey! #HTML_Template</a> Grab your
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>
              &copy; 2024 <Link to="/">Shop Cart</Link>ΣDesigned by{" "}
